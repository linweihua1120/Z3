...
//SEGGER_RTT_printf( 0 , "\r\nAv = %x\r\n " , dwAddr );
  ...
  */
  ...
  while (wDataLength)
  {
    ...
    {
      eResultFlag = ERROR;
//  SEGGER_RTT_printf(0, "eResultFlag = ERROR  break \r\n");
      break;
    }
    dwOffsetAddr += 4;
    wDataLength -= 4;
  }
//  SEGGER_RTT_printf(0, "flash = %x  dwAddr = %x\r\n", HW32_REG(dwAddr),dwAddr);
//  SEGGER_RTT_printf(0, "input = %x\r\n", HW32_REG(pucDataBuf));
// print_int_array( 0 , " Flash" , HW32_REG(dwAddrdwAddr, 8);
// print_int_array( 0 , " input" , (uint8_t*)pucDataBuf, 8);
//  SEGGER_RTT_printf( 0 , " \r\n eResultFlag  = %x\r\n " ,eResultFlag  );
...
// 	  SEGGER_RTT_printf(0, "d=%x\r\n" ,dwAddr   );
      ...
      if (0 == READ_BIT(FLASH->WRPR, (1U << ucSector)))
      {
  SEGGER_RTT_printf(0, "APP_PageErase error 3 \r\n"  );
        eResultFlag = ERROR;
        break;
      }
#endif
      ...
      {
  SEGGER_RTT_printf(0, "APP_PageErase error 2 \r\n"  );
        eResultFlag = ERROR;
        break;
      }
#endif
      ...
      {
  SEGGER_RTT_printf(0, "APP_PageErase error 1    dwAddr = %x\r\n",  dwAddr  );
        eResultFlag = ERROR;
        break;
      }      
...
//  SEGGER_RTT_printf(0, "APP_PageErase succeed \r\n"  );
